...
UCLASS()
class BEYONDONLINE2_API ABaseGizmo : public AActor
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Gizmo")
	void Call_Select_Highlight(UPrimitiveComponent* Component);

		UFUNCTION(BlueprintImplementableEvent)
			void Select_Highlight(UPrimitiveComponent* Component);
